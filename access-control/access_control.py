...
class AccessControl(AbstractDetector):
    ...
    WIKI = "https://github.com/trailofbits/slither/wiki/Detector-Documentation#improper-access-control"
...
"""
    ...
    def _detect(self):
        ...
        self.init = ["init", "set"]  # 스토리지를 초기화하거나 셋팅하는 함수
        # written in init
        self.init_state_variable = []  # write하는데 권한을 요구하는 스토리지 변수
        ...
        for contract in self.compilation_unit.contracts:
            ...
            for function in contract.functions:
                ...
                if len(intersection) > 0:
                    info = ["improper access control in ", function, "\n"]
                    res = self.generate_result(info)
                    results.append(res)
